...
final class Constants
{
     ...
     * Order: មិគសិរ, បុស្ស, មាឃ, ផល្គុន, ចេត្រ, ពិសាខ, ជេស្ឋ, អាសាឍ, ស្រាពណ៍, ភទ្របទ, អស្សុជ, កក្ដិក, បឋមាសាឍ, ទុតិយាសាឍ
     */
    public const LUNAR_MONTHS = [
        'មិគសិរ' => 0,
        'បុស្ស' => 1,
        'មាឃ' => 2,
        'ផល្គុន' => 3,
     ...
     */
    public const MOON_STATUS_SHORT = [
        'ក',
        'រ'
    ];
